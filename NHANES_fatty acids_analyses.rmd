...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(fat_res_alcSmkAct_sexInt) %>% kable_classic()
```
...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(fat_res_alcSmkAct_male) %>% kable_classic()
```
...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(fat_res_alcSmkAct_female) %>% kable_classic()
```
...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(subtypes_res_sexInt) %>% kable_classic()
```
...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(subtypes_res_male) %>% kable_classic()
```
...
```{r, warning=FALSE, message=FALSE, echo = F}
kable(subtypes_res_female) %>% kable_classic()
```
